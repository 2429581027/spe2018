...
#./download_smpl_data.sh ../datageneration/smpl_data
#wget --user=${username} --password=${password} -m -q -i files/files_smpl_data.txt --no-host-directories -P ${outdir}
wget --user=${username} --password=${password} -c https://lsh.paris.inria.fr/SURREAL/smpl_data/smpl_data.npz -P ${outdir}